...
RUN apk update && apk add --no-cache openbox xfce4-terminal firefox-esr tigervnc novnc websockify bash sudo dbus-x11 xauth tzdata curl git font-noto adwaita-icon-theme
